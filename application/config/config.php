...
|
*/
$config['base_url'] = sprintf('%s://%s%s%s',PROTOCOL,HOST,PORT == 80 ? '' : sprintf(':%s',PORT),BASE);
...
|
*/
$config['encryption_key'] = 'PMSQ1001227019MB';
...
$config['csrf_token_name'] = 'ENC_CSRF_PRTC';
$config['csrf_cookie_name'] = 'COK_CSRF';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = FALSE;
$config['csrf_exclude_uris'] = ['Json/FetchData'];
...
spl_autoload_register(function($Class){
    $File = sprintf('%score/%s.php',APPPATH,$Class);
